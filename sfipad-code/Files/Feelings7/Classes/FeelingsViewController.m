...
@synthesize moodKeyboard,textView, myFM;
...
-(void) matchAnimationTo:(NSDictionary *) userInfo {
    ...
    //END:code.textinput.animation
    //START:code.textinput.height
-(CGFloat) keyboardEndingFrameHeight:(NSDictionary *) userInfo {
    ...
    //END:code.textinput.height
    //START:code.textinput.frame
...
-(void)setFileManager:(MyFileManager *)newFM {
    self.myFM = newFM;
    self.textView.delegate = self.myFM;
}
